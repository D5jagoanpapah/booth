...
<div class="login-container">
    <div class="login-card">
        <div class="login-left">
            <h2>Halo👋, Selamat datang di <span class="fw-bold">BRO</span> <span class="text-white fw-bold">BOOTH</span>.</h2>
            <p>Silahkan Login terlebih dahulu jika anda sebelumnya memiliki akun</p>
        </div>
